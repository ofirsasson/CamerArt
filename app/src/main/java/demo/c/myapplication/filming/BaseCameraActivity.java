...
public abstract class BaseCameraActivity extends Activity implements OnImageAvailableListener {
    ...
    protected void setFragment() {
        ...
        final demo.c.myapplication.filming.CameraConnectionFragment fragment =
                demo.c.myapplication.filming.CameraConnectionFragment.newInstance(
                        new demo.c.myapplication.filming.CameraConnectionFragment.ConnectionCallback() {
                            @Override
    ...
    public void requestRender() {
        final demo.c.myapplication.filming.OverlayView overlay = (demo.c.myapplication.filming.OverlayView) findViewById(R.id.debug_overlay);
        if (overlay != null) {
            overlay.postInvalidate();
        }
    }
    public void myrequestRender() {
        final demo.c.myapplication.filming.OverlayView overlay = (demo.c.myapplication.filming.OverlayView) findViewById(R.id.snapshot_view);
        if (overlay != null) {
            overlay.postInvalidate();
        }
    }
    public void addCallback(final demo.c.myapplication.filming.OverlayView.DrawCallback callback) {
        final demo.c.myapplication.filming.OverlayView overlay = (demo.c.myapplication.filming.OverlayView) findViewById(R.id.debug_overlay);
        if (overlay != null) {
            overlay.addCallback(callback);
        }
    }
    public void myaddCallback(final demo.c.myapplication.filming.OverlayView.DrawCallback callback) {
        final demo.c.myapplication.filming.OverlayView overlay = (demo.c.myapplication.filming.OverlayView) findViewById(R.id.snapshot_view);
        if (overlay != null) {
            overlay.addCallback(callback);
        }
